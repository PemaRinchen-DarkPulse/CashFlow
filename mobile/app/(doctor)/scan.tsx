...
function ScanAction({ icon, title, description, color, onPress }: ScanActionProps) {
  return (
    <Pressable
      onPress={onPress}
      style={({ pressed }) => [actionStyles.card, pressed && actionStyles.pressed]}
    >
      <View style={[actionStyles.iconContainer, { backgroundColor: color + '15' }]}>
      ...
      >
        ...
        <View style={styles.scannerPreview}>
          <View style={styles.scannerFrame}>
            ...
            <Text style={styles.scannerText}>Scan patient QR code</Text>
          </View>
        ...
        <View style={styles.actionList}>
          <ScanAction
            ...
            description="Access patient records instantly"
            color={Colors.primary}
            onPress={() => {}}
          />
          <ScanAction
            icon="document-text-outline"
            title="View Scanned Records"
            description="Recently scanned patient records"
          ...
          <ScanAction
            ...
            description="Scan for emergency patient info"
            color={Colors.error}
            onPress={() => {}}
          />
        </View>
