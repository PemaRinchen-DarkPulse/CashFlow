      ...
      >
        ...
        <View style={styles.scannerPreview}>
          <View style={styles.scannerFrame}>
            ...
            <Text style={styles.scannerText}>Scan prescription barcode</Text>
          </View>
        ...
        <View style={styles.actionList}>
          <ScanAction
            ...
            description="Scan prescription barcode to dispense"
          ...
          <ScanAction
            ...
            description="Scan medication barcode to verify"
          ...
          <ScanAction
            ...
            description="Scan items for stock management"
            color="#7B1FA2"
            onPress={() => {}}
          />
        </View>
